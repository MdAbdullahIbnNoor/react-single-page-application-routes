...
{/* <h2 className='text-5xl font-semibold text-black text-center'>Navbar</h2>
      <span className='text-5xl font-semibold text-black text-center font-mono'>My Website</span>
        <nav className='flex gap-10'>
            <a className='mr-8 text-xl font-medium text-blue-600' href="/">Home</a>
            <a className='mr-8 text-xl font-medium text-blue-600' href="/about">About</a>
            <a className='mr-8 text-xl font-medium text-blue-600' href="/contact">Contact Us</a>
      <Link className='text-xl font-medium text-blue-600' to="/">Home</Link>
      <Link className='text-xl font-medium text-blue-600' to="/about">About</Link>
      <Link className='text-xl font-medium text-blue-600' to="/users">Users</Link>
      <Link className='text-xl font-medium text-blue-600' to="/contact">Contact</Link>
      </nav> */}
