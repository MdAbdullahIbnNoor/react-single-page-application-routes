...
const Users = () => {
    ...
    return (
        <div className="h-100vh">
            ...
            <h2 className="mt-96 mb-10 text-center text-gray-800 text-7xl">Our Users: {users.length}</h2>
            <div className="text-gray-900 text-xl font-medium grid grid-cols-3 gap-4 mx-auto justify-center w-3/5 mb-10">
                {
